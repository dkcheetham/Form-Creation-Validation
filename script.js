document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (event) {
        ...
        // Username validation (must be more than 3 characters)
        ...
        if (isValid) {
            ...
            feedbackDiv.style.color = "#ffffff"; // White text color
            feedbackDiv.style.backgroundColor = "#28a745"; // Green background for success
        } else {
            feedbackDiv.innerHTML = messages.join("<br>");
            feedbackDiv.style.color = "#dc3545"; // Red text for error
            feedbackDiv.style.backgroundColor = "#f8d7da"; // Light red background for error
        }
    });
});